// MongoDB Seed Data Script - Queen's Blood Style Game (50 Cards)
// Run this after initializing the schema
// mongosh <connection-string> < mongodb-seed-data-50cards.js
...
const testInventory = {
  ...
  cards: [
    ...
    { cardId: insertedCards.insertedIds['1'], quantity: 3, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['2'], quantity: 2, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['5'], quantity: 2, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['10'], quantity: 1, acquiredAt: new Date() },
    // Buff cards
    { cardId: insertedCards.insertedIds['20'], quantity: 2, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['21'], quantity: 2, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['24'], quantity: 1, acquiredAt: new Date() },
    // Debuff cards
    { cardId: insertedCards.insertedIds['35'], quantity: 2, acquiredAt: new Date() },
    { cardId: insertedCards.insertedIds['38'], quantity: 1, acquiredAt: new Date() }
  ],
  characters: [
    ...
    { characterId: insertedCharacters.insertedIds['4'], acquiredAt: new Date() }
  ],
  createdAt: new Date(),
  updatedAt: new Date()
};
